...
export function ProfilePage({ user, desk, isSelf }: Props) {
  ...
  return (
    <section className="flex w-full max-w-lg flex-col gap-8 font-display text-ink">
      ...
      <div className="flex items-center gap-4 rounded-xl p-5 ring-1 ring-inset ring-line">
        <span
          aria-hidden
          className="grid size-14 flex-none place-items-center rounded-full bg-moss text-[20px] font-bold text-white"
        >
          {initials}
        </span>
